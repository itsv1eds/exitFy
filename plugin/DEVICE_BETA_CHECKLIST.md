...
- Confirm the plugin is `exitFy_v2`, version `4.0.0`, schema 6, and an
...
connect/disconnect cycles and 72-hour soak are gates for stable `4.0.0`, which
